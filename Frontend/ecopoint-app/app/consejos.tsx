...
const consejos = [
    {
      ...
      description: "Limpia y seca bien los envases antes de reciclar para evitar la contaminación y mejorar el proceso de reciclaje.",
      image: require("../assets/consejo1.jpg"),
    },
    {
      id: 2,
      title: "Consejo #2: Reutilización",
      description: "Reduce, reutiliza y luego recicla. Piensa en cómo puedes dar un nuevo uso a artículos antes de tirarlos.",
      image: require("../assets/consejo2.jpg"),
    },
    {
      id: 3,
      title: "Consejo #3: Tecnología a tu favor",
      description: "Utiliza aplicaciones que te ayudan a encontrar centros de reciclaje, aprender nuevas técnicas y recibir alertas ecológicas.",
      image: require("../assets/consejo3.jpg"),
    },
    {
      id: 4,
      title: "Consejo #4: Participación Comunitaria",
      description: "Únete a grupos locales de reciclaje y participa en campañas comunitarias para un impacto mayor y más efectivo.",
          ...
          {consejos.map((consejo) => (
            <View key={consejo.id} style={styles.consejoContainer}>
              ...
              <View style={styles.textContainer}>
                ...
                <Text style={styles.consejoDescription}>{consejo.description}</Text>
              </View>
            </View>
          ))}
        </ScrollView>
